...
(function() {
  ...
  var colors = ['rgb(0, 18, 255)', 'rgb(255, 0, 138)', 'rgb(0, 221, 141)', 'rgb(120, 0, 255)', 'rgb(255, 92, 0)'].sort(function() { return Math.random() - 0.5; });

  var intro = document.querySelector('.intro');
  var introBottom = intro.getBoundingClientRect().bottom + 10 || 120;

  var yOffset = introBottom;
